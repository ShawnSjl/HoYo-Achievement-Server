...
本项目基于 Java 开发，采用 RESTful API
架构，为前端提供业务接口支持，并负责解析和同步 [HoYo-Achievement-Data](https://github.com/ShawnSjl/HoYo-Achievement-Data)
中的游戏数据。
...
- **推荐：** 项目默认使用JGit来从[HoYo-Achievement-Data](https://github.com/ShawnSjl/HoYo-Achievement-Data)中克隆和拉取数据
- 如果需要手动管理，需要在运行参数中添加`--app.data.enable-jgit=false`
